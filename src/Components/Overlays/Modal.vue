        ...
        <div class="flex min-h-full items-end justify-center p-4 text-center sm:items-center sm:p-0">
          ...
          >
            <DialogPanel class="relative transform overflow-hidden rounded-lg bg-white px-4 pt-5 pb-4 text-left shadow-xl transition-all sm:my-8 sm:w-full sm:max-w-sm sm:p-6">
              <div v-if="!hideClose" class="absolute top-0 right-0 hidden pt-4 pr-4 sm:block">
                <button
                    type="button"
              ...
              <div>
                <DialogTitle v-if="$slots.title || title" as="h3" class="mb-2 text-lg font-medium leading-6 text-gray-900">
